# server side code for meristogram shiny app
# functions split up to allow optimization of speed of application

# create a function with arguments:
# hookMeasurements
# lerp

# default to smallest movAvgSeg, but allow user to modify this with slider
# 
...
standardizeHookMeasurements <- function(hookMeasurements) # this function and stdHooks2Meristogram designed to be used only within shiny app
{
...
stdHooks2Meristogram <- function(stdHooks, movAvgSeg, lerp=T) # shiny app only
{ 
